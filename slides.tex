...
% xmu beamer
\usepackage{XMUBeamerBlue}	%厦大蓝
% \usepackage{XMUBeamerRed}	%嘉庚红

\author{\href{https://iceduu.github.io}{iceduu}}
...
\begin{frame}{改动说明}
    \begin{itemize}
        \item 调整至厦门大学厦大蓝以及嘉庚红两种主题颜色
        \item 对alertblock的颜色进行了更改
        \item 对footline进行了调整
...
\begin{frame}{主题色选择}
	\begin{itemize}
		...
		\item 厦大蓝请使用\textbackslash usepackage\{XMUBeamerBlue\}
		\item 嘉庚红请使用\textbackslash usepackage\{XMUBeamerRed\}
	\end{itemize}
	...
	\begin{figure}[htbp]
		...
		\subfigure[厦大蓝] %第一张子图
		{
			\begin{minipage}{0.45\linewidth}
				\centering          %子图居中
				\includegraphics[scale=0.35]{pic/cover_blue}
			\end{minipage}
		}
		\subfigure[嘉庚红] %第二张子图
		{
			\begin{minipage}{0.45\linewidth}
				\centering      %子图居中
				\includegraphics[scale=0.35]{pic/cover_red}  
			\end{minipage}
		}
		\caption{每个主题色对应封面}
	\end{figure}
